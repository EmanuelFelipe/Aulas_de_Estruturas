...
int procura_registro(Lista * l1){
    ...
    if(l1->primeiro_elemento == NULL){
        ...
        Registro * aux = l1->primeiro_elemento;
        Registro * aux2 = aux->proximo_elemento;
        Registro * anterior = aux2;
        while(aux != NULL){
            if(aux->valor == aux2->valor){
                anterior = aux2;
                aux2 = aux->proximo_elemento;
                x = 1;
                remove_especifico(anterior->valor,l1);
            }if(x == 0){
            aux2 = aux2->proximo_elemento;
            }else if(x == 1){
                x = 0;
            }
            if(aux2 == NULL){
                aux = aux->proximo_elemento;
                aux2 = aux->proximo_elemento->proximo_elemento;
            }
        }
    }
}
